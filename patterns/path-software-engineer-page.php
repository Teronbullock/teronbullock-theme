...
/**
 * Title: TB Theme Path: Software Engineer
 * Slug: tb-theme/path-software-engineer
 * Categories: posts
 * Description: Theme software engineer page setup.
 */
?>
      ...
      <div class="wp-block-column" style="flex-basis:45%">
        ...
        <div class="wp-block-buttons">
          ...
          <div class="wp-block-button is-style-outline"><a
              ...
              href="/custom-web-solutions/#how-i-help" style="border-radius:3px;background-color:#ffffff00">I Need A
              Site</a></div>
          <!-- /wp:button -->
...
<div id="how-i-help" class="wp-block-group has-white-smoke-background-color has-background">
  <!-- wp:group {"tagName":"section","metadata":{"name":"Value Prop"},"align":"full","className":"section-group is-style-default","style":{"spacing":{"padding":{"top":"7.5rem","bottom":"7.5rem"}}},"backgroundColor":"white","textColor":"dark","layout":{"type":"constrained","contentSize":"900px","wideSize":"1320px","justifyContent":"center"}} -->
  <section
    ...
    style="padding-top:7.5rem;padding-bottom:7.5rem">
      ...
      <div class="wp-block-columns alignfull">
        ...
        <div class="wp-block-column" style="flex-basis:80%">
          ...
          <h2
            ...
            style="margin-bottom:2rem;font-style:normal;font-weight:400">Focused, Hands-On, and Hungry to Improve</h2>
          <!-- /wp:heading -->

          <!-- wp:paragraph {"fontSize":"medium","fontFamily":"heading"} -->
          <p class="has-heading-font-family has-medium-font-size">I dive deep into every project. I build, I learn, and
            I come back with smarter, more reliable solutions. Each challenge teaches me something new, and I use that
            growth to deliver work I can stand behind.</p>
          <!-- /wp:paragraph -->
...
<section
  class="wp-block-group alignfull section-group section-group--skills is-style-default has-light-color has-secondary-background-color has-text-color has-background"
  ...
  <div
    ...
    <div class="wp-block-column">
      ...
      <figure class="wp-block-image aligncenter size-large is-resized"><img
          ...
          alt="Technology Icon" style="aspect-ratio:1;object-fit:cover;width:100px;height:undefinedpx" /></figure>
      <!-- /wp:image -->
...
<!-- wp:group {"tagName":"section","metadata":{"name":"Feat. Projects"},"align":"full","className":"section-group section-group\u002d\u002dproject is-style-default","style":{"spacing":{"padding":{"top":"6.75rem","bottom":"6.75rem","left":"2rem","right":"2rem"}}},"backgroundColor":"white","textColor":"primary","layout":{"type":"constrained","contentSize":"900px","wideSize":"1320px"}} -->
<section
  class="wp-block-group alignfull section-group section-group--project is-style-default has-primary-color has-white-background-color has-text-color has-background"
      ...
      <div class="wp-block-group">
        ...
        <div class="wp-block-buttons">
          ...
          <div class="wp-block-button is-style-outline"><a
              ...
              href="http://l/project/">View All Projects</a></div>
          <!-- /wp:button -->
        </div>
        <!-- /wp:buttons -->
      </div>
  ...
  <div class="wp-block-group is-style-container">
    ...
    <div class="wp-block-columns is-style-container" style="padding-right:0px;padding-left:0px">
      ...
      <div class="wp-block-column is-vertically-aligned-top">
        ...
        <p class="has-heading-font-family has-medium-font-size" style="margin-bottom:1rem">If you're looking for someone
          who shows up, learns fast, and solves problems without ego — let's talk.</p>
        <!-- /wp:paragraph -->
...
<!-- wp:group {"metadata":{"name":"Spacer"},"className":"is-style-default","backgroundColor":"white-smoke","layout":{"type":"constrained","contentSize":"900px","wideSize":"1320px"}} -->
...
<section id="contact"
  ...
  <div
    ...
    <h2
      ...
      style="margin-bottom:1.5rem">Ready to Connect?</h2>
    <!-- /wp:heading -->

    <!-- wp:paragraph {"align":"center","fontSize":"medium","fontFamily":"heading"} -->
    <p class="has-text-align-center has-heading-font-family has-medium-font-size">Let's discuss how I can solve your
