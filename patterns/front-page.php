    ...
    <div class="wp-block-columns alignfull is-style-img-right-col" style="padding-right:0px;padding-left:0px">
      ...
      <div class="wp-block-column is-vertically-aligned-top">
        ...
        <h1 class="wp-block-heading has-text-align-left has-heading-font-family"
          style="margin-bottom:1.5rem;font-style:normal;font-weight:500">Teron Bullock,<br>Full-Stack Software Engineer
        </h1>
        <!-- /wp:heading -->
        ...
        <p class="has-heading-font-family" style="margin-bottom:1rem"><strong>From patient care to clean code.</strong>
          I'm a developer who brings empathy, a problem-solving mindset, and a proven ability to master complex systems.
        </p>
        <!-- /wp:paragraph -->
        ...
        <!-- wp:paragraph {"style":{"spacing":{"margin":{"bottom":"1rem"}}},"fontFamily":"heading"} -->
        <p class="has-heading-font-family" style="margin-bottom:1rem">I build full-stack applications with modern
          JavaScript to solve real business problems. Reliable, collaborative, and driven by growth.</p>
        <!-- /wp:paragraph -->
        ...
        <div class="wp-block-buttons">
          ...
          <div class="wp-block-button is-style-outline"><a
              ...
              style="border-radius:4px">View my work</a></div>
          <!-- /wp:button -->
        </div>
        <!-- /wp:buttons -->
      </div>
