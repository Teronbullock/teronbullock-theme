 ...
 */
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"Hero"},"align":"full","className":"section-group section-group\u002d\u002dabout is-style-default","style":{"spacing":{"padding":{"top":"6.75rem","bottom":"6.75rem"}}},"backgroundColor":"primary","textColor":"white","layout":{"type":"constrained"},"anchor":"hero"} -->
<section
  ...
  <div class="wp-block-group is-style-container">
    ...
    <div class="wp-block-columns alignfull is-style-img-right-col" style="padding-right:0px;padding-left:0px">
      ...
      <div class="wp-block-column is-vertically-aligned-top">
        <!-- wp:heading {"level":1,"placeholder":"Section Heading","style":{"spacing":{"margin":{"bottom":"1.5rem"}},"typography":{"fontStyle":"normal","fontWeight":"500","textAlign":"left"}},"fontFamily":"heading"} -->
        ...
        <p class="has-heading-font-family" style="margin-bottom:1rem"><strong>From patient care to clean code.</strong>
          Hi my name is Teron but everyone calls me "Ron". I'm a developer who brings empathy, a problem solving
          mindset, and a proven ability to master complex systems.</p>
        <!-- /wp:paragraph -->
...
<!-- wp:group {"tagName":"section","metadata":{"name":"Feat. Projects"},"align":"full","className":"section-group section-group\u002d\u002dproject is-style-default","style":{"spacing":{"padding":{"top":"6.75rem","bottom":"6.75rem","left":"2rem","right":"2rem"}}},"backgroundColor":"white-smoke","textColor":"primary","layout":{"type":"constrained"},"anchor":"projects"} -->
<section
  ...
  <!-- wp:heading {"style":{"spacing":{"margin":{"bottom":"3rem"}},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}},"typography":{"textAlign":"center"}},"textColor":"primary","fontSize":"x-large"} -->
  <h2
    class="wp-block-heading has-text-align-center has-primary-color has-text-color has-link-color has-x-large-font-size"
    style="margin-bottom:3rem">Projects</h2>
  <!-- /wp:heading -->

  <!-- wp:columns {"align":"wide","className":"is-style-container"} -->
  <div class="wp-block-columns alignwide is-style-container">
    <!-- wp:column -->
    <div class="wp-block-column">
      <!-- wp:query {"queryId":37,"query":{"perPage":3,"pages":"0","offset":0,"postType":"project","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"parents":[],"format":[],"taxQuery":{"include":{"project_type":[93]}}}} -->
      <div class="wp-block-query">
        ...
        <!-- wp:post-title {"textAlign":"left","level":3,"isLink":true,"style":{"typography":{"fontStyle":"normal","fontWeight":"500","textTransform":"capitalize","textDecoration":"none"},"spacing":{"margin":{"bottom":"0"}},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary","fontSize":"lg"} /-->
        <!-- /wp:post-template -->
      </div>
      <!-- /wp:query -->
      ...
      <div class="wp-block-group">
        ...
        <div class="wp-block-buttons">
          <!-- wp:button {"textColor":"primary","className":"is-style-outline","style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}},"typography":{"textAlign":"center"}},"fontFamily":"heading"} -->
          <div class="wp-block-button is-style-outline"><a
              class="wp-block-button__link has-primary-color has-text-color has-link-color has-heading-font-family has-text-align-center wp-element-button"
              href="/project">View All Projects</a></div>
          <!-- /wp:button -->
        </div>
        <!-- /wp:buttons -->
      </div>
...
<!-- wp:group {"tagName":"section","metadata":{"name":"skills"},"align":"full","className":"section-group section-group\u002d\u002dskills is-style-default","style":{"spacing":{"padding":{"top":"4rem","bottom":"4rem"}}},"backgroundColor":"primary","textColor":"light","layout":{"type":"constrained"},"anchor":"skills"} -->
<section
  ...
  <!-- wp:heading {"placeholder":"Section Heading","style":{"spacing":{"margin":{"bottom":"5rem"}},"elements":{"link":{"color":{"text":"var:preset|color|white"}}},"typography":{"textAlign":"center"}},"textColor":"white","fontSize":"x-large"} -->
  ...
  <!-- wp:columns {"align":"wide","className":"tb-container is-style-columns\u002d\u002dskills","style":{"spacing":{"margin":{"bottom":"5rem"},"blockGap":{"top":"var:preset|spacing|70"}},"elements":{"link":{"color":{"text":"var:preset|color|white"}}}},"textColor":"white"} -->
  <div
    ...
    <div class="wp-block-column">
      ...
      <!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"0rem"}},"typography":{"textAlign":"center"}}} -->
...
<!-- wp:group {"tagName":"section","metadata":{"name":"Testimonials"},"align":"full","className":"section-group section-group\u002d\u002dabout is-style-default","style":{"spacing":{"padding":{"top":"6.75rem","bottom":"6.75rem"}}},"backgroundColor":"white-smoke","textColor":"secondary","layout":{"type":"constrained"},"anchor":"testimonials"} -->
<section
  ...
  <!-- wp:group {"align":"full","className":"is-style-container","layout":{"type":"constrained"}} -->
  <div class="wp-block-group alignfull is-style-container">
    <!-- wp:heading {"placeholder":"Section Heading","style":{"spacing":{"margin":{"bottom":"4rem"}},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}},"typography":{"textAlign":"center"}},"textColor":"primary","fontSize":"x-large"} -->
    <h2
      class="wp-block-heading has-text-align-center has-primary-color has-text-color has-link-color has-x-large-font-size"
      style="margin-bottom:4rem">Testimonials</h2>
    <!-- /wp:heading -->
...
<!-- wp:group {"tagName":"section","metadata":{"name":"CTA"},"className":"section-group is-style-default","style":{"spacing":{"padding":{"top":"4rem","bottom":"4rem"}}},"backgroundColor":"white-smoke","textColor":"dark","layout":{"type":"constrained"},"anchor":"contact"} -->
<section id="contact"
  ...
  <!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"top":"2.5rem","bottom":"2.5rem","left":"2.5rem","right":"2.5rem"}},"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}}},"backgroundColor":"white","textColor":"secondary","layout":{"type":"constrained"}} -->
  <div
    ...
    <!-- wp:heading {"style":{"spacing":{"margin":{"bottom":"1.5rem"}},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}},"typography":{"fontStyle":"normal","fontWeight":"600","textAlign":"center"}},"textColor":"primary","fontSize":"xl"} -->
    ...
    <!-- wp:paragraph {"className":"has-primary-color has-text-color has-link-color has-heading-font-family","style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}},"typography":{"textAlign":"center"}},"textColor":"primary"} -->
    ...
    <div
      ...
      <div class="wp-block-column is-vertically-aligned-center cta has-heading-font-family">
        <!-- wp:shortcode -->
        [contact-form-7 id="e112a94" title="Contact form 1"]
        <!-- /wp:shortcode -->
      </div>
      <!-- /wp:column -->
    </div>
