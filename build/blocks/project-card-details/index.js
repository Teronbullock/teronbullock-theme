...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/project-card-details/editor.scss");
...
function Edit({
  ...
  const termCatIds = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useRef)({});
  const termIds = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useRef)();
  const termNames = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useRef)('');
  let detailText = '';
  if (attributes.detailType === 'category') {
    const taxonomies = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => {
      if (postId) {
    ...
    const {
      record: termNameRecord,
      hasResolved: termNameHasResolved
    } = (0,_wordpress_core_data__WEBPACK_IMPORTED_MODULE_4__.useEntityRecord)('postType', postType, postId);
